...
- **OSC Output** — what Gesture sends, to where, and the three output formats.
- **TouchDesigner, Max, Unity, Isadora** — patterns for the most common receivers.
